 ...
 *
 * Floating WhatsApp button that appears on all viewports.
 * Features:
 ...
 *
 * HOW TO CUSTOMIZE:
 * - Update WhatsApp number at line ~18: +628xxxxxxxxxx
 */
...
const FloatingWhatsApp = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 w-14 h-14 md:w-16 md:h-16
